...
interface ArtistService {
    ...
    @GET("searchalbum.php")
    suspend fun searchAlbum(@Query("s") artistName: String): Response<AlbumResponse>

    @GET("album.php")
    suspend fun albumDetail(@Query("m") albumId: String): Response<AlbumDetailResponse>

    @GET("track.php")
    suspend fun albumTracks(@Query("m") albumId: String): Response<TrackResponse>
}